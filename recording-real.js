...
export function mountRealRecording(root,{toast}) {
  ...
  const summary=document.createElement('section');summary.className='real-classroom-summary';summary.innerHTML='<div class="real-summary-head"><h2>课堂摘要</h2><span>按课堂时间顺序</span></div><div class="real-summary-tabs"><button type="button" class="active" data-summary-filter="all">全部</button><button type="button" data-summary-filter="ppt">PPT</button><button type="button" data-summary-filter="video">视频</button><button type="button" data-summary-filter="desktop">电脑桌面</button></div><div class="real-summary-timeline"></div>';
